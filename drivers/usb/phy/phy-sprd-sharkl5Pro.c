...
static int phy_sprd_sharkl5pro_notify_connect(struct usb_phy *phy,
...
static int phy_sprd_sharkl5pro_notify_disconnect(struct usb_phy *phy,
                                      enum usb_device_speed speed)
{
	//struct sprd_glue *glue;
...
#ifdef PRJ_FEATURE_H_BOARD_DOCKING_SUPPORT
	phy->phy.notify_connect     = phy_sprd_sharkl5pro_notify_connect;
	phy->phy.notify_disconnect  = phy_sprd_sharkl5pro_notify_disconnect;
#endif
	otg->usb_phy = &phy->phy;
